$(document).ready(function(){
	...
	$('.gg-icon-buscar').button({height:30,text:false,icons:{primary: 'ui-icon-search'}});
	$('.dialogo').dialog({
		autoOpen: false,
		hide: 'blind',
		resizable: true,
...
function productos(categoria,id_campo){
	$.post("ajax.php",{a: "listar-producutos",cat:categoria}, function(data){
		if(data.estatus)
		{
